...
export function isInboundQueueMessage(
	payload: unknown,
): payload is InboundQueueMessage {
	return (
		typeof payload === "object" &&
		payload !== null &&
		"rawBlobKey" in payload &&
		"from" in payload &&
		"to" in payload
	);
}

export function isWebhookRetryMessage(
	payload: unknown,
): payload is WebhookRetryMessage {
	return (
		typeof payload === "object" &&
		payload !== null &&
